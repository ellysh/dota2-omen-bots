...
function M.UpdateState()
  ...
  M.GAME_STATE = {
    ...
    [M.BOT_HAS_MP_FOR_CYCLONE_AND_REQUIEM] =
    ...
    [M.BOT_CASTABLE_NEAR_SHADOWRAZE] =
      NUM[env.NEAR_SHADOWRAZE_ABILITY:IsFullyCastable()],

    [M.BOT_CASTABLE_MEDIUM_SHADOWRAZE] =
      NUM[env.MEDIUM_SHADOWRAZE_ABILITY:IsFullyCastable()],

    [M.BOT_CASTABLE_FAR_SHADOWRAZE] =
      NUM[env.FAR_SHADOWRAZE_ABILITY:IsFullyCastable()],

    [M.BOT_CASTABLE_REQUIEM] =
      NUM[env.REQUIEM_ABILITY:IsFullyCastable()],
  ...
  if env.ENEMY_HERO_DATA ~= nil then
   ...
   M.GAME_STATE[M.EH_IN_NEAR_SHADOWRAZE_RANGE] =
    NUM[constants.NEAR_SHADOWRAZE_MIN_RANGE <= env.ENEMY_HERO_DISTANCE
        and env.ENEMY_HERO_DISTANCE
            <= constants.NEAR_SHADOWRAZE_MAX_RANGE]

   M.GAME_STATE[M.EH_IN_MEDIUM_SHADOWRAZE_RANGE] =
    NUM[constants.MEDIUM_SHADOWRAZE_MIN_RANGE <= env.ENEMY_HERO_DISTANCE
        and env.ENEMY_HERO_DISTANCE
            <= constants.MEDIUM_SHADOWRAZE_MAX_RANGE]

   M.GAME_STATE[M.EH_IN_FAR_SHADOWRAZE_RANGE] =
    NUM[constants.FAR_SHADOWRAZE_MIN_RANGE <= env.ENEMY_HERO_DISTANCE
        and env.ENEMY_HERO_DISTANCE
            <= constants.FAR_SHADOWRAZE_MAX_RANGE]

   M.GAME_STATE[M.EH_CAN_EVADE_REQUIEM] =
    NUM[(constants.REQUIEM_MAX_RANGE - env.ENEMY_HERO_DISTANCE)
        < env.ENEMY_HERO_REQUIEM_EVADE_DISTANCE]
    ...
    if env.ENEMY_HERO_DATA.active_ability ~= nil
      ...
      M.GAME_STATE[M.BOT_CAN_EVADE_NEAR_SHADOWRAZE_BACK] =
        NUM[(constants.NEAR_SHADOWRAZE_MAX_RANGE - env.ENEMY_HERO_DISTANCE)
            < env.BOT_SHADOWRAZE_EVADE_DISTANCE]

      M.GAME_STATE[M.BOT_CAN_EVADE_MEDIUM_SHADOWRAZE_BACK] =
        NUM[(constants.MEDIUM_SHADOWRAZE_MAX_RANGE - env.ENEMY_HERO_DISTANCE)
            < env.BOT_SHADOWRAZE_EVADE_DISTANCE]

      M.GAME_STATE[M.BOT_CAN_EVADE_FAR_SHADOWRAZE_BACK] =
        NUM[(constants.FAR_SHADOWRAZE_MAX_RANGE - env.ENEMY_HERO_DISTANCE)
            < env.BOT_SHADOWRAZE_EVADE_DISTANCE]

      M.GAME_STATE[M.BOT_CAN_EVADE_MEDIUM_SHADOWRAZE_FRONT] =
        NUM[(env.ENEMY_HERO_DISTANCE - constants.MEDIUM_SHADOWRAZE_MIN_RANGE)
            < env.BOT_SHADOWRAZE_EVADE_DISTANCE]
